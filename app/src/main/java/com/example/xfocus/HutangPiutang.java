...
public class HutangPiutang {
    ...
    public static ArrayList<String> getListHutangPiutang() { return ListHutangPiutang; }
    public static void setListHutangPiutang(ArrayList<String> listHutangPiutang) { ListHutangPiutang = listHutangPiutang; }
}
